...
class Ui_UniFileSyncPop(object):
    def setupUi(self, UniFileSyncPop):
        ...
        self.proxyPwdLineEdit.setEchoMode(QtGui.QLineEdit.Password)
        ...
        self.proxyLabel = QtGui.QLabel(self.proxyGroup)
        self.proxyLabel.setGeometry(QtCore.QRect(20, 20, 91, 31))
        ...
        self.proxyLineEdit = QtGui.QLineEdit(self.proxyGroup)
        self.proxyLineEdit.setGeometry(QtCore.QRect(110, 30, 121, 20))
        ...
        self.serverEnableCheckBox = QtGui.QCheckBox(self.serverGroup)
        self.serverEnableCheckBox.setGeometry(QtCore.QRect(20, 60, 70, 17))
        self.serverEnableCheckBox.setObjectName(_fromUtf8("serverEnableCheckBox"))
    ...
    def retranslateUi(self, UniFileSyncPop):
        ...
        self.proxyLabel.setText(_translate("UniFileSyncPop", "Proxy Server", None))
        ...
        self.serverEnableCheckBox.setText(_translate("UniFileSyncPop", "Enable", None))
